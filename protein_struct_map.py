...
for path, dir_list, file_list in os.walk("/home/lirq/grad_design/Dataset/struct_human"):
    for file_name in file_list:
        ...
        data.to_csv("/home/lirq/grad_design/Dataset/edges_human/" + name + ".txt", sep=" ", index=False, header=False)
        # B_ = matrix2table(B)
        # print(len(A))
        # A_ = matrix2table()
